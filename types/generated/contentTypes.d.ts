...
export interface ApiCustomDesignRequestCustomDesignRequest
  extends Struct.CollectionTypeSchema {
  collectionName: 'custom_design_requests';
  info: {
    description: 'Custom design requests from customers';
    displayName: 'Custom Design Request';
    pluralName: 'custom-design-requests';
    singularName: 'custom-design-request';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    adminNotes: Schema.Attribute.RichText;
    ...
    estimatedPrice: Schema.Attribute.Decimal;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::custom-design-request.custom-design-request'
    > &
      Schema.Attribute.Private;
    materials: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    referenceImages: Schema.Attribute.Media<'images' | 'files', true>;
...
export interface ApiNewsletterSubscriptionNewsletterSubscription
  ...
  info: {
    description: 'Newsletter subscription entries from website visitors';
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Storefront products exposed to the React app';
    displayName: 'Product';
    pluralName: 'products';
...
export interface ApiSearchQuerySearchQuery extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Track client search queries from the frontend app';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    resultsCount: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    searchQuery: Schema.Attribute.String & Schema.Attribute.Required;
    searchType: Schema.Attribute.String & Schema.Attribute.DefaultTo<'general'>;
    source: Schema.Attribute.String & Schema.Attribute.DefaultTo<'app'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::custom-design-request.custom-design-request': ApiCustomDesignRequestCustomDesignRequest;
